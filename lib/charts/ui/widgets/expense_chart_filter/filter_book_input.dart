  ...
  Widget build(BuildContext context) {
    return BlocSelector<SelectOptionsBloc, SelectOptionsState, SelectOptionsModel>(
        ...
        builder: (context, state) {
          return BlocSelector<ChartExpenseCategoryBloc, ChartExpenseCategoryState, dynamic>(
            ...
            builder: (context, state1) {
              return MySelect(
                ...
                value: state1,
                onChange: (value) {
                  context.read<ChartExpenseCategoryBloc>().add(ChartExpenseCategoryQueryChanged({'bookId': value}));
                },
